    ...
    return (
      <div className={styles.wrapper}>
        ...
        <svg x="0px" y="0px" viewBox="0 0 1077.57 1429.08" style={{ enableBackground: "new 0 0 1077.57 1429.08" }}>
          ...
          <g id={styles.Layer_2}>
            <g>
			<path className={styles.st48} d="M952,295c-0.8-2-1.8-4.2-2.5-6.6c-0.3-1-0.4-2.7,0-3.3c1-1.3,2.5-1.3,3.3,0.5c2.2,5,4.3,10.2,6.3,15.4
			c0.2,0.5-0.1,1.6-0.4,2c-3.3,3.9-6.7,7.8-10.4,12c-0.7-1.9-1.2-3.3-1.9-5.3c1.8-2.1,3.8-4.6,6.3-7.5c-3.3-1.8-6-1.5-8.6,0
			c-6.4,3.7-9.5,11-10.3,20.6c-0.5,6.6,0.5,12.7,3.5,18.2c0.9,1.6,2.1,3.2,3.4,4c2.3,1.4,1.2,3.1,0.8,4.7c-0.5,2.2-1.8,0.9-2.5,0.2
			c-5.2-4.3-7.9-11.1-9-18.9c-2.1-14.9,3.1-29.2,12.8-34.3C945.5,295.5,948.7,295.6,952,295z"/>
		<path className={styles.st48} d="M958.5,342.6c-2.1,2.6-4.3,5.2-7,8.6c1.8,0.4,3.1,0.9,4.3,0.8c5.1-0.4,8.8-4,11.3-9.8
			c3.5-8,4.5-16.7,1.2-25.9c-1-2.9-2.8-5.6-4.6-7.7c-2.4-3-2.6-2.9-0.8-6.7c4.9,2.8,8,8,9.8,14.8c4.3,16.3-0.8,33.5-11.6,39.5
			c-2.5,1.4-5.4,1.4-8.3,2.1c0.8,1.9,1.6,3.9,2.4,5.8c0.5,1.3,1.6,2.6,0.2,3.9c-1.4,1.2-2.6,1.1-3.5-1.1c-1.4-3.3-2.8-6.5-4.3-9.8
			c-2.5-5.8-2.5-5.8,1-10.1c1.8-2.2,3.6-4.4,5.4-6.6C956.1,337.8,956.4,337.9,958.5,342.6z"/>
            </g>
            <g>
              <path
                className={styles.st48}
