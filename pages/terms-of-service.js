...
export default function TermsOfService() {
  ...
  return (
    <div className={"pageWrapper bg"} style={{ backgroundColor: "whitesmoke" }}>
      ...
      <ul>
        <li key={uniqueIDs[0]}>
          (Copyright status) All copyrights to Ardi are exclusively owned by
          Open Soft inc (WWW:{" "}
        ...
        <li key={uniqueIDs[1]}>
          (Distribution status) The Ardi may be freely distributed, provided the
          distribution package should not be modified. No person or company may
          charge a fee for the distribution of Ariadne Organizer without written
          permission from the copyright holder.
        </li>
        <li key={uniqueIDs[2]}>
          Ardi IS DISTRIBUTED "AS IS". NO WARRANTY OF ANY KIND IS EXPRESSED OR
          IMPLIED. YOU USE AT YOUR OWN RISK. THE AUTHOR WILL NOT BE LIABLE FOR
        ...
        <li key={uniqueIDs[4]}>
          Installing and using Ardi signifies acceptance of these terms and
          conditions of the license.
        </li>
        <li key={uniqueIDs[5]}>
          If you do not agree with the terms of this license you must remove
          Ardi files from your storage devices and cease to use the product.
        </li>
      </ul>
